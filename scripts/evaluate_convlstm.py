...
from src.models.convlstm import TemperatureConvLSTM, device


DEFAULT_DATASET = PROJECT_ROOT / "data" / "train_data"
DEFAULT_CHECKPOINT = PROJECT_ROOT / "checkpoints" / "convlstm_base.pth"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate the ConvLSTM model.")
    parser.add_argument("--dataset", default=str(DEFAULT_DATASET), help="Dataset directory.")
    parser.add_argument("--checkpoint", default=str(DEFAULT_CHECKPOINT), help="ConvLSTM checkpoint path.")
