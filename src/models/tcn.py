...
os.makedirs('outputs/checkpoints/tcn', exist_ok=True)
...
class TemperatureTCN(nn.Module):
    def __init__(self, seq_length=30, input_features=70, num_channels=[16, 32, 64], kernel_size=3):
...
def train_model(model, train_dataloader, valid_dataloader, num_epochs=300, resume_path=None):
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        if avg_val_loss < best_val_loss:
            ...
            }, 'outputs/checkpoints/tcn/8_16_32.pth')
